...
const diff_parser_1 = __nccwpck_require__(5107);
const minimatch_1 = __importDefault(__nccwpck_require__(2002));
const nodemailer_1 = __importDefault(__nccwpck_require__(8106));
const ai_1 = __nccwpck_require__(430);
const review_1 = __nccwpck_require__(6504);
function main() {
    var _a, _b, _c, _d, _e;
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            if (eventName === "pull_request") {
                ...
                const pull_number = (_b = github.context.payload.pull_request) === null || _b === void 0 ? void 0 : _b.number;
                if (!pull_number)
                ...
                contextDetails = {
                    ...
                    pull_number,
                    title: prData.title,
                    description: (_c = prData.body) !== null && _c !== void 0 ? _c : "",
                };
                // 获取 diff
                ...
                // 解析 diff
                const parsedDiff = (0, diff_parser_1.parseDiff)(diff);
                ...
                // 调用 AI
                const comments = yield (0, ai_1.analyzeCode)(filteredDiff, contextDetails);
                if (comments.length > 0) {
                    // 评论到 PR
                    yield (0, review_1.createReviewComment)(contextDetails.owner, contextDetails.repo, contextDetails.pull_number, comments);
                }
            }
                ...
                contextDetails = {
                    ...
                    description: (_e = (_d = eventData.head_commit) === null || _d === void 0 ? void 0 : _d.message) !== null && _e !== void 0 ? _e : "",
                };
                // Push 事件调用 AI 分析后的处理
                const reviewComments = yield (0, ai_1.analyzeCode)(filteredDiff, contextDetails);
...
module.exports = eval("require")("./ai");
...
module.exports = eval("require")("diff-parser");
